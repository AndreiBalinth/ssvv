...
public abstract class AbstractXMLRepository<ID, E extends repository.HasID<ID>> extends AbstractCrudRepository<ID, E> implements repository.FileRepository<ID, E> {
