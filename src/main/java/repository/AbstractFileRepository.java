...
public abstract class AbstractFileRepository<ID, E extends repository.HasID<ID>> extends repository.AbstractCrudRepository<ID, E> implements repository.FileRepository<ID, E> {
